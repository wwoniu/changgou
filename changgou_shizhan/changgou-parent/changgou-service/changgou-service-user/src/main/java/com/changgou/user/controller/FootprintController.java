...
public class FootprintController {
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "Footprint对象",value = "传入JSON数据",required = false) Footprint footprint,@PathVariable Integer id){
        //设置主键值
        footprint.setId(id);
    ...
    public Result addBySkuId(@RequestParam("skuId") Integer skuId) {
        String username = "sztheima";
