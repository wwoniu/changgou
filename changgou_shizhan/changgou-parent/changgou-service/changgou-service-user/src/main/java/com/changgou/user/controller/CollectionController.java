...
public class CollectionController {
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "Collection对象",value = "传入JSON数据",required = false) Collection collection,@PathVariable Integer id){
        //设置主键值
        collection.setId(id);
     ...
     */
    @PostMapping
    public Result add(@RequestBody  @ApiParam(name = "Collection对象",value = "传入JSON数据",required = true) Collection collection){
